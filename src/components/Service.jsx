    ...
    <section className="w-screen py-8 dark:bg-slate-800">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 items-center px-12 md:px-24 py-6 gap-4">
        ...
        <Skills
          ...
          title="Designing"
          description=" I create engaging and intuitive designs using tools like Figma and Adobe XD. My designs are always user-centered and tailored to the specific needs of my clients."
          tools="FIGMA, ADOBE XD, ADOBE PHOTOSHOP"
        />
        <Skills
          img="https://images.pexels.com/photos/546819/pexels-photo-546819.jpeg"
          title="Frontend Development"
          description="I work closely with my clients to understand their business goals and user needs, and I use my expertise to implement interfaces that are both functional and aesthetically pleasing."
          tools="HTML, CSS, JAVASCRIPT, REACT, TAILWINDCSS"
        />
        <Skills
          img="https://images.pexels.com/photos/4559592/pexels-photo-4559592.jpeg"
          title="Mentoring"
          description=" I am passionate about helping others grow in their careers. I share my knowledge and experience to help aspiring developers improve their skills and achieve their goals."
