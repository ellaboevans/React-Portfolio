...
function Footer() {
  ...
  return (
    <footer className="flex dark:bg-slate-700 bg-gray-200 text-center md:text-left space-y-10 flex-col  md:flex md:space-y-0 md:flex-row items-center justify-between w-screen duration-100 mt-8 py-10 px-10 xl:px-36 ">
      <div>
        <Link
          to="/"
