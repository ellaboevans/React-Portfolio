...
function Home() {
  ...
  return (
    <div className="overflow-x-hidden bg-white dark:bg-slate-800 duration-100">
      ...
      <div className=" flex items-center px-4 md:px-8 jusitfy-between h-screeen py-32 w-full bg-white dark:bg-slate-800 duration-100 my-8 md:my-0">
        {/* Left Side Items */}
        <div className="hidden md:flex items-center flex-col space-y-3 mt-28 md:mt-0 px-3 animate-[bounce_4s_infinite] hover:animate-none">
          ...
          <div className="dark:bg-slate-400 items-center flex p-2 rounded-full cursor-pointer hover:translate-x-2 duration-500 ease">
            <ion-icon name="logo-github" title="Github"></ion-icon>
          </div>
          <div className="dark:bg-slate-400 items-center flex p-2 rounded-full cursor-pointer hover:translate-x-2 duration-500 ease">
            <ion-icon name="logo-reddit" title="Reddit"></ion-icon>
          </div>
          <div className="dark:bg-slate-400 items-center flex p-2 rounded-full cursor-pointer hover:translate-x-2 duration-500 ease">
